...
uint32_t cs43l22_Init(uint16_t DeviceAddr, uint16_t OutputDevice, uint8_t Volume, uint32_t AudioFreq)
{
  ...
  counter += CODEC_IO_Write(DeviceAddr, CS43L22_REG_INTERFACE_CTL1, 0x4);
...
uint32_t cs43l22_ReadID(uint16_t DeviceAddr)
{
  ...
  status = HAL_I2C_Mem_Read(&hi2c1, DeviceAddr, 0x94, 0x1, &Value, 1, 0xA000);
...
static uint8_t CODEC_IO_Write(uint8_t Addr, uint8_t Reg, uint8_t Value)
{
  ...
  result = HAL_I2C_Mem_Write(&hi2c1, Addr, (uint16_t)Reg, I2C_MEMADD_SIZE_8BIT, &Value, 1, 0xA000);
